...
if __name__ == '__main__':
    ...
    xs, ys = get_x_y('20220721',INPUT_WINDOW,PREDICT_WINDOW,INCREASE)
    n, l, _ = xs.shape
    ...
    # model = LSTM_Attention(10, 512, 1, 2).to(device)
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            test_conf_mat_en = ConfusionMatrix(num_classes=1, threshold=1. / 1)  # Confusion Matrix
            model.eval()
            val_epoch_loss = 0
            n_batch_size = 0
            all_acc = 0
